...
/*
 * - Доделать основные механики.
 * - Протестировать в простых кейсах. Симуляция через AI.
 * - Переименование названий файлов.
 * - COMMAND - step.
 * - Выделить проверки команд в отдельную сущность
 * - AI -> AI_Unit
 * - Контейнеры сущностей
 * - Очередь как отдельная сущность.
