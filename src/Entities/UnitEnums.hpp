...
namespace sw::entities
{
    ...
    // Необходим для более безопасной подмены AI и временных запретов механик
    ...
    // Никаких лишних проверок поиска пути для башни проведено не будет. Так же нам не нужно беспокоиться из-за не указанной скорости башни.
    enum UnitMechanic {
        MOVE,
        RANGE_ATTACK,
        MELEE_ATTACK
