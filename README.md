...
По логике не атакуют, и действительно, тогда это препятствие. Требований к алгоритмам поиска пути нет, поэтому решение обхода трупа на ваше усмотрение, пусть даже случайный шаг в любом направлении. Пояснение: 
Пояснение: алгоритм поиска пути просто ищет ближайшую из доступных точек. Точка тела это наземное препятствие. Если доступных позиций нет, то просто ждём.  
